  ...
  if (req.isAuthenticated()) {
    pool.connect(function (conErr, client, done) {
      if (conErr) {
        ...
        client.query("INSERT INTO mytasks(usersapp_id, task_id, firstcompleteddate, task_name, task_description, freq_day, freq_type, task_due_date) SELECT usersapp_id, task_id, firstcompleteddate, task_name, task_description, freq_day, freq_type, $1 FROM mytasks WHERE mytask_id=$2;",
